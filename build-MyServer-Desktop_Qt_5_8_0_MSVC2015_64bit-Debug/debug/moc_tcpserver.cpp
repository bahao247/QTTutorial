...
QT_MOC_LITERAL(5, 36, 13), // "TcpConnecton*"
QT_MOC_LITERAL(6, 50, 10), // "connection"
QT_MOC_LITERAL(7, 61, 8), // "finished"
QT_MOC_LITERAL(8, 70, 8) // "complete"

    },
    "TcpServer\0accepting\0\0qintptr\0handle\0"
    "TcpConnecton*\0connection\0finished\0"
    "complete"
};
...
void TcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->accepting((*reinterpret_cast< qintptr(*)>(_a[1])),(*reinterpret_cast< TcpConnecton*(*)>(_a[2]))); break;
        ...
        {
            typedef void (TcpServer::*_t)(qintptr , TcpConnecton * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpServer::accepting)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpServer::finished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TcpServer::accepting(qintptr _t1, TcpConnecton * _t2)
{
